...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ].join(" ").trim()}" data-svelte-h="svelte-1ar2g9k">Choose Username</a> <a href="/login/photo" class="${[
    "step",
    $page.route.id?.includes("photo") ? "step-primary" : ""
  ].join(" ").trim()}" data-svelte-h="svelte-198hyx1">Upload Photo</a></ul></nav> ${validate_component(AnimatedRoute, "AnimatedRoute").$$render($$result, {}, {}, {
    default: () => {
